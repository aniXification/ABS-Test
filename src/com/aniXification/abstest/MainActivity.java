...
public class MainActivity extends SherlockListActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		sub.add(0, R.style.Theme_Sherlock_Light, 0, "Default");
		sub.add(0, R.style.Theme_Sherlock, 0, "Dark");
		sub.add(0, R.style.Theme_Sherlock_Light_DarkActionBar, 0, "Light (Dark ActionBar)");
	...
	protected List<Map<String, Object>> getData(String prefix){
    	...
    	mainIntent.addCategory("com.aniXification.abstest.TEST");
